...
const Bucket = 'aws-deploy-lite-test-pkg'
const base = path.join(process.cwd(), 'test', 'mock-pkg')
...
const index = `export default async function handler (event, context) {
  return 'hello world'
}`

test('can package a sam.json document', async t => {
